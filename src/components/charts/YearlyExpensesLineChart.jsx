...
const YearlyExpensesLineChart = ({ isDashboard = false }) => {
  ...
  var chartData = {
    ...
    datasets: [
      {
        label: "Average",
        data: data?.xAverage?.map((x) => x.expenses),
      ...
      {
        label: "2023",
        data: data?.x2023?.map((x) => x.expenses),
      ...
      {
        label: "2022",
        data: data?.x2022?.map((x) => x.expenses),
      ...
      {
        label: "2021",
        data: data?.x2021?.map((x) => x.expenses),
      ...
      {
        label: "2020",
        data: data?.x2020?.map((x) => x.expenses),
...
export default YearlyExpensesLineChart;
